...
def find_average_len(burst_results) -> dict:
    print("***** EKEEL - Video Annotation: burst_results_processor.py::find_average_len(): ******")
    """
...
def get_json_with_bursts(burst_results, sents_idx):
    ...
    print("***** EKEEL - Video Annotation: burst_results_processor.py::get_json_with_bursts(): Inizio ******")
...
def give_direction_using_first_burst(undirected_matrix: pd.DataFrame,
    ...
    print("***** EKEEL - Video Annotation: burst_results_processor.py::give_direction_using_first_burst(): ******")
...
def to_edgelist(df):
    print("***** EKEEL - Video Annotation: burst_results_processor.py::to_edgelist(): ******")
    edges = []
